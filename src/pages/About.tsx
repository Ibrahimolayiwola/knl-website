    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-20 px-4">
        <div className="container mx-auto max-w-5xl">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-destructive text-center mb-12">
            Our Core Values
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {leadership.map((leader, index) => (
              <div key={index} className="text-center">
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden mx-auto mb-4 border-4 border-secondary">
                  <img 
                    src={leader.image} 
                    alt={leader.name}
      ...
      <section className="py-12 px-4 bg-foreground/10">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-destructive mb-10">
            Certifications & Partners
          </h2>
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {
              partnerLogos.map((logo, i) => (
                 <div key={i} className="w-26 h-16 md:w-32 md:h-20 bg-white shadow-lg rounded-lg flex items-center justify-center">
              <img src={logo} alt="ccecc logo design" className="w-full object-cover"/>
            </div>
              ))
            }
      ...
      <section className="py-16 md:py-20 px-4 bg-muted/50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-destructive
      ...
      <section className="py-16 md:py-20 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-destructive mb-4">
